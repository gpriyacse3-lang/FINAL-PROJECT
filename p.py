...
file_path = r"C:\FINAL PROJECT\AI-powered-customer-analytics--FINAL-PROJECT-main\customer_insights.pkl"
...
with tab1:
    ...
    """
    response = model.generate_content(prompt)   # ✅ correct Gemini call
...
with tab4:
    ...
    revenue_file = r"C:\FINAL PROJECT\AI-powered-customer-analytics--FINAL-PROJECT-main\fiscal_revenue_usd_summary.csv"
